  ...
  switch (command.toLowerCase()) {
    ...
    case 'projects':
      return wrap(
        <ul>
          <li>
            <strong>Notes App</strong> [<a href="https://github.com/VarshiniShreeV/Notes_App" target="_blank">GitHub</a>] – A simple note-taking app built with Flask supporting CRUD functionality.
          </li>
          <li>
            <strong>Web Scrapers Collection</strong> [<a href="https://github.com/VarshiniShreeV/Scrapers" target="_blank">GitHub</a>] – Scraped and visualized data from Behance, Deals Heaven, and US Libraries.
          </li>
          <li>
            <strong>Mini Desktop Tools</strong> [<a href="https://github.com/VarshiniShreeV/OIBSIP" target="_blank">GitHub</a>] – Desktop tools (BMI calculator, password generator, chat app) made using PyQt5.
          </li>
          <li>
            <strong>Simple Calculator</strong> [<a href="https://github.com/VarshiniShreeV/Simple-calculator" target="_blank">GitHub</a>] – A responsive calculator UI built with HTML and CSS.
          </li>
          <li>
            <strong>Portfolio Website</strong> [<a href="https://varshinishreev.github.io/Portfolio/" target="_blank">Live Link</a>] – ReactJS-based personal site with project highlights and resume.
          </li>
          <li>
            <strong>Attendance Management System</strong> [<a href="https://github.com/RohiniSivapalan/AMS" target="_blank">GitHub</a>] – Collaborative project for student tracking and reporting at the School of Innovation.
          </li>
        </ul>
      );
